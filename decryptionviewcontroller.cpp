...
//    DecryptionItem *item5 = new DecryptionItem();
//    item5->fileName->setText(tr("春游4.jpg"));
//    item5->fileSize->setText(tr("15KB"));
//    item5->fileDescription->setText("主体文件指定分享");
//    item5->downloadBtn->setText("确认下载");
//    item5->fileIcon->setText(tr("图标"));
